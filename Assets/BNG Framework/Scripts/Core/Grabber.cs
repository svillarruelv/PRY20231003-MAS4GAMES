...
namespace BNG
{
  ...
  public class Grabber : MonoBehaviour
  {
    ...
    /// Which controller side. None if not attached to a controller.
    /// </summary>
    [Tooltip("The default object to grab.")]
    public Grabbable defaultObject;
    ...
    void Update()
    {
      ...
      else if (HoldingItem == false)
      {
        ...
        else if (HandSide == ControllerHand.Right && InputBridge.Instance.RightTrigger > 0.9f)
        {
          TryGrab();
        }
      }
